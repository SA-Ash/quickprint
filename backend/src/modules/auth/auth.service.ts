...
export const authService = {
  ...
  /**
   * Login or create user with Firebase-verified phone number
   * Used when user has verified their phone via Firebase Phone Auth
   */
  async loginOrCreateWithPhone(input: {
    ...
    const { phone, firebaseUid, college, isPartner } = input;
